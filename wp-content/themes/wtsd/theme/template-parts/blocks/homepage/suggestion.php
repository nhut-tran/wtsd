...
<section class="suggestion mt-[72.5px] md:mt-[80.5px] lg:mt-[100px] md:px-[63px] lg:px-[230px]">
    <div class="grid w-full grid-cols-[280px] justify-center gap-[64px]
        ...
        <h1 class="text-3xl text-center tracking-[0.2px] md:col-span-2 mx-auto font-bold mb-[-9px] px-5 sm:text-left md:ml-0 md:text-[40px] leading-[52px] lg:text-5xl max-w-[280px] md:pl-0  md:max-w-[522px] md:mb-[72px] xl:mb-[81px]">
            <?php echo $tips_title ?></h1>
        <?php if (have_rows('suggestion_text_box')) : ?>

            <?php while (have_rows('suggestion_text_box')) : the_row(); ?>

                <div class="suggestion__text-box flex <?php $index = get_row_index();
                                                        echo  $index % 2 == 0 ? 'md:pt-[72px] lg:pt-[135px]' : '' ?> flex-col items-center justify-start text-center min-h-[405px] sm:text-left">
                    <picture>
                        <source media="(min-width: 768px)" srcset="<?php the_sub_field('suggestion_text_box_image_desktop'); ?>">
                    ...
                    <div>
                        ...
                        <p class="text-sm sm:text-base mx-5 leading-6 sm:mx-0 sm:leading-7 sm:max-w-[266px] lg:max-w-[346px] sm:self-start">
