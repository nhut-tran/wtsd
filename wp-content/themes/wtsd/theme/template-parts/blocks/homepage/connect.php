...
<section class="connect mt-24 sm:px-5 md:px-10 lg:px-0 flex flex-col items-center">
    ...
    <div
        ...
        <div class="text-box pl-6 pr-5 pt-4 pb-5 md:pt-5 lg:pt-4">
            <h2 class=" text-box__title lg:text-[2rem] text-[24px] leading-8 lg:leading-10 font-bold">
                <?php the_sub_field('text_box_title'); ?></h2>
            <h4 class="text-base font-semibold mb-[9px] mt-3 leading-5"><?php the_sub_field('text_box_sub_title'); ?>
                <h4>
                    <p class="text-sm leading-6"><?php the_sub_field('text_box_text'); ?>
                    </p>
        </div>
        <?php endwhile; ?>
